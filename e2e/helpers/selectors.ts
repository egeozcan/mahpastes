...
export const selectors = {
  ...
  header: {
    ...
    searchOptionsButton: '[data-testid="search-options-button"]',
    searchOptionsPopover: '[data-testid="search-options-popover"]',
    searchOptionContent: '[data-testid="search-option-content"]',
    searchOptionHidden: '[data-testid="search-option-hidden"]',
    searchOptionsFolderNote: '[data-testid="search-options-folder-note"]',
  ...
  gallery: {
    ...
    clipVideo: '#gallery > li video',
    clipVideoThumb: '#gallery > li img.video-thumb',
  ...
  lightbox: {
    ...
    zoomControl: '#lightbox-zoom-control',
